...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\swiffout on
     Windows, /home/user/dev/swiffout on Linux) in a file named
     swiffout@grownsoftware and copy that file to
